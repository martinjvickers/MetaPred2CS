...
my $cmd = qx(rm -rf Blast_output_formatted_prt1 myHits_prt1.fasta myHits_prt1.fasta.dnd myHits_prt1.fasta.unique Blast_output_formatted_prt2 myHits_prt2.fasta myHits_prt2.fasta.dnd myHits_prt2.fasta.unique && mv *.pir $output_dir);
